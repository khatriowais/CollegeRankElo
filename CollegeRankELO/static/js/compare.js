...
(function(){
  ...
  function render(d){
    ...
    const rows = [
      ['Annual fee',      fmt(d.a.annual_fee, '₹'),      fmt(d.b.annual_fee, '₹'),      cmpWin(d.a.annual_fee, d.b.annual_fee, false)],
      ['Avg package',     fmt(d.a.average_package, '₹'), fmt(d.b.average_package, '₹'), cmpWin(d.a.average_package, d.b.average_package)],
      ['Highest package', fmt(d.a.highest_package, '₹'), fmt(d.b.highest_package, '₹'), cmpWin(d.a.highest_package, d.b.highest_package)],
  ...
  function fmt(n, prefix=''){ return n == null ? '—' : prefix + Number(n).toLocaleString('en-IN'); }
